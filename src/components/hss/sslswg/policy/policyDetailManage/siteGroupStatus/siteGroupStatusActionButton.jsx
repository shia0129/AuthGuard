...
import { setParameters } from '@modules/redux/reducers/hss/sslswg/site/siteGroupStatus';

function SiteGroupStatusActionButton(props) {
    ...
    <>
      ...
      {modalOpen && (
        <SiteGroupStatusModal
          ...
          getSiteGroupStatusList={inquiryClickButton}
        />
      )}
    </>
  );
...
export default SiteGroupStatusActionButton;
