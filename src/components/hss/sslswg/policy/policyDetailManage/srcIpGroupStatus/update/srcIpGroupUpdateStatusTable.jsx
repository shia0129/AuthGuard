...
import { setDeleteList } from '@modules/redux/reducers/hss/sslswg/srcIp/srcIpGroupUpdateStatus';
import HsReduxTable from '@components/modules/table/HsReduxTable';

function SrcIpGroupUpdateStatusTable() {
  const { deleteList } = useSelector((state) => state.srcIpGroupUpdateStatus);
...
export default SrcIpGroupUpdateStatusTable;
