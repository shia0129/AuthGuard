...
const XYChart_tmp = dynamic(() => import('@components/third-party/am-chart/4/XYChart4_tmp'), {
  ssr: false,
});
...
function BarChartData_tmp({ id, theme = 'dark', chartData = sampleChartData , customHandler = null }) {
  //console.log("@@@@ ", id ," @@@@");
  return (
    <Stack sx={{ mt: 1, height: '100%' }}>
      <XYChart_tmp id={id} theme={theme} chartData={chartData} customHandler={customHandler} />
    </Stack>
  );
}

export default BarChartData_tmp;
