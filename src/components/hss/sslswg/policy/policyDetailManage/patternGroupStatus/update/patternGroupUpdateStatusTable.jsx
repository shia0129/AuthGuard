...
import { setDeleteList } from '@modules/redux/reducers/hss/sslswg/pattern/patternGroupUpdateStatus';
import HsReduxTable from '@components/modules/table/HsReduxTable';

function PatternGroupUpdateStatusTable() {
  const { deleteList } = useSelector((state) => state.patternGroupUpdateStatus);
...
export default PatternGroupUpdateStatusTable;
