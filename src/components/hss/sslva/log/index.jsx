...
import VALogTable from './VALogTable';
import VALogSearchForm from './VALogSearchForm';
import VALogSearchActionButton from './VALogSearchActionButton';
...
function LogList() {
  ...
  const getLogList = useCallback(
    async (param = {}, showModal = false) => {
      ...
      const log_name = parameters.segmentName + '/sslva';
  ...
  return (
    <GridItem spacing={2} container direction="column">
      ...
      <VALogSearchForm />
      <VALogSearchActionButton onSearchButtonClick={(params) => getLogList(params, true)} />
      {isMount && <VALogTable />}
    </GridItem>
  );
}
