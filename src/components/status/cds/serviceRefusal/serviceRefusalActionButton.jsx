...
import { setParameters } from '@modules/redux/reducers/serviceRefusalHistory';

function ServiceRefusalActionButton({ onSearchButtonClick, onExcelButtonClick, onPdfButtonClick }) {
...
export default ServiceRefusalActionButton;
