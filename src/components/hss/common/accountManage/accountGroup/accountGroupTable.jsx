...
import { setDeleteList } from '@modules/redux/reducers/hss/common/accountGroup';
import { Link } from '@mui/material';
import HsReduxTable from '@components/modules/table/HsReduxTable';
import AccountGroupModal from '@components/modal/hss/common/accountManage/accountGroupModal';

function AccountGroupTable(props) {
  const { getAccountGroupList } = props;

  const { columns, deleteList } = useSelector((state) => state.accountGroup);
