...
function TransferUserPasswordEditPopup(userSeq) {
  ...
  const doSave = async (data) => {
    ...
    const result = await apiCall(transferUserApi.saveAdminList, data);
...
TransferUserPasswordEditPopup.getLayout = function getLayout(page) {
  return (
    <Layout variant="popup" title="사용자 비밀번호 변경">
      {page}
    </Layout>
  );
};

export default TransferUserPasswordEditPopup;
