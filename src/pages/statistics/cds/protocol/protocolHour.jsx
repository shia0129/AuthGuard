...
function ProtocolHour() {
  ...
  const [protocolHourList, setProtocolHourList] = useState([
    {
      systemSeq: '시스템',
      statisticalItems: '-',
      hour1: '00',
  ...
  const init = async () => {
    const gridInfo = await HsLib.getGridInfo('ProtocolHourList', statisticsApi);
  ...
  const getProtocolHourList = (parameters) => {
    // 시간별 목록 조회 api 추가.
  };
    ...
    <GridItem spacing={2} container direction="column">
      ...
      <GridItem item>
        <ReactTable
          ...
          columns={columns}
          data={protocolHourList}
          setData={setProtocolHourList}
          gridInfo={gridInfo}
