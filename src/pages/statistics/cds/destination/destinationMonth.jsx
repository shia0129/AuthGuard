...
function DestinationMonth() {
  ...
  const init = async () => {
    const gridInfo = await HsLib.getGridInfo('DestinationMonth', statisticsApi);
  ...
  const getDestinationMonth = (parameters) => {
    // 월별 목록 조회 api 추가.
  };
  ...
  return (
    <GridItem spacing={2} container direction="column">
      ...
      <GridItem item>
        <ReactTable
          listFuncName="getDestinationMonth"
          columns={columns}
          data={destinationMonth}
          setData={setDestinationMonth}
          gridInfo={gridInfo}
