...
import { setParameters, setSearchOpenFlag } from '@modules/redux/reducers/transHistory';
import { Stack, IconButton } from '@mui/material';
import { DownOutlined, UpOutlined } from '@ant-design/icons';
import CodeInput from '@components/modules/input/CodeInput';

function TransmissionSearchForm() {
...
export default TransmissionSearchForm;
