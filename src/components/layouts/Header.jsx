...
// project import
import { DEFAULT_PATH } from 'src/config';
...
const Header = ({ handleDrawerOpen, layout = 'landing', ...others }) => {
  ...
  const userName = useSelector((state) => state.common.userInfo.userName);
              ...
              <Stack direction="row" spacing={2}>
                ...
                <IconButton
                  ...
                  sx={{
                    '&:hover': {
                      bgcolor:
                        theme.palette.mode === 'dark' ? 'secondary.lighter' : 'secondary.dark',
                    },
                  }}
                >
                  <MenuOutlined
                    style={{
                      color: theme.palette.mode === 'dark' ? 'inherit' : theme.palette.grey[100],
                    }}
                  />
                </IconButton>
              </Stack>
