...
import { setParameters } from '@modules/redux/reducers/hss/sslswg/pattern/patternStatus';

function PatternStatusActionButton(props) {
    ...
    <>
      ...
      {modalOpen && (
        <PatternStatusModal
          ...
          getPatternStatusList={inquiryClickButton}
        />
      )}
    </>
  );
...
export default PatternStatusActionButton;
